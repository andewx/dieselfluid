...
func TestScalarSum(t *testing.T) {
	fmt.Printf("-----TEST QUATERNION----\n\n")
	fmt.Printf("Testing Scalar Sum\n")
	if Sum(qs1, qs2) != qs3 {
		t.Fail()
	}
}
...
func TestVectorProd(t *testing.T) {
	fmt.Printf("Testing Vector Prod\n")
